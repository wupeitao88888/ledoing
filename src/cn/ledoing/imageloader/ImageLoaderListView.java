...
import cn.ledoing.imageloader.ImageSizeUtil.ImageSize;
 ...
 * 
 */
public class ImageLoaderListView
{
	private static ImageLoaderListView mInstance;
	...
	private ImageLoaderListView(int threadCount, Type type)
	{
	...
	public static ImageLoaderListView getInstance()
	{
		if (mInstance == null)
		{
			synchronized (ImageLoaderListView.class)
			{
				if (mInstance == null)
				{
					mInstance = new ImageLoaderListView(DEAFULT_THREAD_COUNT, Type.LIFO);
				}
			}
		}
		return mInstance;
	...
	public static ImageLoaderListView getInstance(int threadCount, Type type)
	{
		if (mInstance == null)
		{
			synchronized (ImageLoaderListView.class)
			{
				if (mInstance == null)
				{
					mInstance = new ImageLoaderListView(threadCount, type);
				}
			}
		}
		return mInstance;
