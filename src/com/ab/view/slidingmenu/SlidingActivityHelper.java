...
public class SlidingActivityHelper {
	 ...
	 * hierarchy. It can itself be a complex view hierarchy. When calling this method, the lc_update_sex_layout parameters
	 * of the specified view are ignored. Both the width and the height of the view are set by default to
	 * MATCH_PARENT. To use your own lc_update_sex_layout parameters, invoke setContentView(android.view.View,
