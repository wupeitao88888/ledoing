...
public class PullToRefreshView extends LinearLayout {
     ...
     * Footer加载更多监听器.
     */
    private OnFooterLoadListener1 mOnFooterLoadListener;

    /**
     * Header下拉刷新监听器.
     */
    private OnHeaderRefreshListener1 mOnHeaderRefreshListener;
    ...
    private void initContentAdapterView() {
        ...
        if (count < 3) {
            throw new IllegalArgumentException("this lc_update_sex_layout must contain 3 child views,and AdapterView or ScrollView must in the second position!");
        }
        View view = null;
        ...
        if (mScrollView == null) {
            throw new IllegalArgumentException("must contain a AdapterView or ScrollView in this lc_update_sex_layout!");
        }
    }
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (mPullState == PULL_DOWN_STATE) {
                    ...
                    // 执行上拉
                    footerPrepareToRefresh(deltaY, y);
                }
                mLastMotionY = y;
                break;
            //UP和CANCEL执行相同的方法
            ...
            case MotionEvent.ACTION_CANCEL:
                ...
                if (mPullState == PULL_DOWN_STATE) {
                    ...
                    if (Math.abs(topMargin) > mHeaderViewHeight + mFooterViewHeight) {
                        ...
                        // 还没有执行刷新，重新隐藏
                        setFooterMargin(-mHeaderViewHeight);
                    }
                }
                break;
     ...
     * @param deltaY 手指滑动的距离
     */
    private void footerPrepareToRefresh(int deltaY, int y) {
        if (mPullRefreshing || mPullLoading) {
            return;
        }
        int newTopMargin = updateHeaderViewTopMargin(deltaY);
    ...
    private void setFooterMargin(int topMargin) {
        LayoutParams params = (LayoutParams) mHeaderView.getLayoutParams();
        params.topMargin = topMargin;
        mHeaderView.setLayoutParams(params);
        invalidate();
     ...
     */
    public void setOnHeaderRefreshListener(OnHeaderRefreshListener1 headerRefreshListener) {
     ...
     */
    public void setOnFooterLoadListener(OnFooterLoadListener1 footerLoadListener) {
     ...
     * @see
     */
    public interface OnFooterLoadListener1 {
     ...
     * @see
     */
    public interface OnHeaderRefreshListener1 {
