...
public class WheelRecycle {
	...
	/**
	 * Recycles items from specified lc_update_sex_layout.
	 * There are saved only items not included to specified range.
	 * All the cached items are removed from original lc_update_sex_layout.
	 * 
	 * @param layout the lc_update_sex_layout containing items to be cached
	 * @param firstItem the number of first item in lc_update_sex_layout
