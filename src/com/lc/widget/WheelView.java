...
import com.lc.widget.adapters.WheelViewAdapter;
...
public class WheelView extends View {
	 ...
	 * private int[] SHADOWS_COLORS = new int[] { 0xefFCFCFC, 0xcfE9E9E9,
	 *	0x3fFCFCFC }; //
	 */
	private int[] SHADOWS_COLORS = new int[] { 0xf0ffffff,
					0x5ffffff, 0x00ffffff };
	...
	// Items lc_update_sex_layout
	private LinearLayout itemsLayout;

	// The number of first item in lc_update_sex_layout
	 ...
	 * depends on wheel lc_update_sex_layout parameters. To apply changes and rebuild view
	 * call measure().
	 * 
	 * @param count
	...
	/**
	 * Calculates desired height for lc_update_sex_layout
	 * 
	 * @param layout
	 *            the source lc_update_sex_layout
	 * @return the desired lc_update_sex_layout height
	 */
	 ...
	 * 
	 * @param widthSize
	 *            the input lc_update_sex_layout width
	 * @param mode
	 *            the lc_update_sex_layout mode
	 ...
	 * 
	 * @param width
	 *            the lc_update_sex_layout width
	 * @param height
	 *            the lc_update_sex_layout height
	 */
	...
	/**
	 * Adds view for item to items lc_update_sex_layout
	 * 
	 * @param index
	 *            the item index
	 * @param first
